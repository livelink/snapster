...
describe('single edges', () => {
  test('can snap box to left edge', () => {
    ...
    const snap = new Snap({ grid: grid });
    const box = new Box({ x: 305, y: 400, width: 100, height: 200 });

    expect(snap.to(box)).toEqual({ x: 300, y: 400 });
  });
  ...
  test('can snap box to center edge', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 150, y: 400 });
  });
  ...
  test('can snap box to right edge', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 200, y: 400 });
  });
  ...
  test('can snap box to top edge', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 400, y: 300 });
  });
  ...
  test('can snap box to middle edge', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 400, y: 140 });
  });
  ...
  test('can snap box to bottom edge', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 400, y: 180 });
  });
});
...
describe('multiple edges', () => {
  test('can snap to top left edges', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 300, y: 300 });
  });
  ...
  test('can snap to top center edges', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 200, y: 300 });
  });
  ...
  test('can snap to top right edges', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 1, y: 300 });
  });
  ...
  test('can snap to middle left edges', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 100, y: 140 });
  });
  ...
  test('can snap to middle center edges', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 150, y: 140 });
  });
  ...
  test('can snap to middle right edges', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 1, y: 140 });
  });
  ...
  test('can snap to bottom left edges', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 700, y: 400 });
  });
  ...
  test('can snap to bottom center edges', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 50, y: 380 });
  });
  ...
  test('can snap to bottom right edges', () => {
    ...
    expect(snap.to(box)).toEqual({ x: 550, y: 500 });
  });
});
